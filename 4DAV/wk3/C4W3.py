# -*- coding: utf-8 -*-
"""
Created on Sun Dec 6 21:00:54 2016
...
predvar = data_clean[['incomeperperson','oilperperson','hivrate','alcconsumption',
'armedforcesrate','breastcancerper100th','femaleemployrate','relectricperperson',
'urbanrate','polityscore','suicideper100th','employrate','internetuserate','lifeexpectancy']]

targets = data_clean.co2emissions
...
predictors['breastcancerper100th']=preprocessing.scale(predictors['armedforcesrate'].astype('float64'))
