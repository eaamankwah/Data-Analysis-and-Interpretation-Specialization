...
print (scipy.stats.pearsonr(ad_clean['x11_2013'], ad_clean['x12_2013']))

def incomegrp (row):
   if row['x11_2013'] <= 3010.759:
      return 1
   elif row['x11_2013'] <= 10504.17:
      return 2
   elif row['x11_2013'] > 10504.17:
      return 3
...
print ('association between co2 damage and GDP Anual Growth for LOW income countries')
print (scipy.stats.pearsonr(sub1['x284_2013'], sub1['x12_2013']))
print ('       ')
print ('association between c02 damage and GDP Annual Growth for MIDDLE income countries')
print (scipy.stats.pearsonr(sub2['x284_2013'], sub2['x12_2013']))
print ('       ')
print ('association between co2 damage and GDP Annual Growth for HIGH income countries')
print('\n')
print (scipy.stats.pearsonr(sub3['x284_2013'], sub3['x12_2013']))

############################################################################################
# BASIC LINEAR REGRESSION
############################################################################################

scat1 = sb.regplot(x="x284_2013", y="x12_2013", data=sub1)
plt.xlabel('GDP Annual Growth')
plt.ylabel('Co2 damage')
plt.title('Scatterplot for the Association Between Co2 damage and GDP Annual Growth Rate for LOW income countries')
plt.show()
print (scat1)
print('\n')
print ("OLS regression model for the association between co2 damage rate and urbanization")
reg1 = smf.ols('x284_2013 ~ x12_2013', data=sub1).fit()
print('\n')
print (reg1.summary())


scat2 = sb.regplot(x="x284_2013", y="x12_2013", fit_reg=False, data=sub2)
plt.xlabel('GDP Annual Growth')
plt.ylabel('Co2 demage')
plt.title('Scatterplot for the Association Between Co2 damage and GDP Annual Growth Rate for MIDDLE income countries')
plt.show()
print (scat2)

print('\n')
print ("OLS regression model for the association between co2 damage rate and urbanization")
reg2 = smf.ols('x284_2013 ~ x12_2013', data=sub2).fit()
print('\n')
print (reg2.summary())


scat3 = sb.regplot(x="x284_2013", y="x12_2013", data=sub3)
plt.xlabel('GDP Annual Growth')
plt.ylabel('Co2 demage')
plt.title('Scatterplot for the Association Between Co2 damage and GDP Annual Growth Rate for HIGH income countries')
plt.show()
print (scat3)

print('\n')
print ("OLS regression model for the association between co2 damage rate and urbanization")
reg3 = smf.ols('x284_2013 ~ x12_2013', data=sub3).fit()
print('\n')
print (reg3.summary())
