...
#clean data
data_clean = data[['x12_2012','x1_2012','x21_2012','x36_2012','x161_2012',
'x179_2012','x253_2012']].dropna()
...
predvar= data_clean[['x1_2012','x21_2012','x36_2012','x161_2012','x179_2012',
'x253_2012']]

target = data_clean.x12_2012
...
train['Carbon Dioxide Damage']=train['x12_2012']
train['Urbanization Rate']=train['x1_2012']
train['Energy Depletion']=train['x36_2012']
train['Industry Value Added']=train['x161_2012']
train['Air Polution']=train['x253_2012']
train['Natural Res. Depletion']= train['x21_2012']
train['Food Production']= train['x179_2012']
