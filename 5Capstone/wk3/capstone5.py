# -*- coding: utf-8 -*-
"""
Created on Mon Feb 27 10:20:10 2017
...
#clean data
data_clean = data[['x16_2012','x48_2012','x149_2012','x155_2012','x156_2012',
'x173_2012','x195_2012']].dropna()
...
predvar= data_clean[['x16_2012','x48_2012','x149_2012','x155_2012','x156_2012',
'x173_2012']]

target = data_clean.x195_2012
...
train['Carbon Dioxide Damage']=train['x195_2012']
train['Urbanization Rate']=train['x16_2012']
train['Energy Depletion']=train['x48_2012']
train['Industry Value Added']=train['x149_2012']
train['Air Polution']=train['x155_2012']
train['Natural Res. Depletion']= train['x156_2012']
train['Food Production']= train['x173_2012']

#scatterplot matrix for quantitative variables
fig1 = sns.PairGrid(train, y_vars=["Carbon Dioxide Damage"],
                 x_vars=['Urbanization Rate','Energy Depletion','Industry Value Added',\
                 'Air Polution','Natural Res. Depletion','Food Production'],\
                 palette="GnBu_d")
